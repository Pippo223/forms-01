<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: nameValidity === 'invalid'}">
      ...
      v-model.trim="enteredName" @blur="validateInput" />
      <p v-if="nameValidity === 'invalid'">Please enter a valid name</p>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model.trim="enteredAge"/>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <div>
        ...
        value="nothing" v-model="interest" />
    ...
    <div class="form-control">
      ...
      <div>
        ...
        value="videos" v-model="how" />
        <label for="how-video">Video Courses</label>
      </div>
      <div>
        <input id="how-blogs" name="how" type="radio" 
        value="blogs" v-model="how"/>
        <label for="how-blogs">Blogs</label>
      </div>
      <div>
        <input id="how-other" name="how" type="radio" 
        value="others" v-model="how"/>
